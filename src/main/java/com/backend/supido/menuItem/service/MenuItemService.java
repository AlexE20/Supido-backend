...
public interface MenuItemService {
    ...
    MenuItemDTOResponse updateMenuItem(Long restaurantId, Long id, MenuItemDTORequest request, User user);
    void deleteMenuItem(Long restaurantId, Long id, User user);
    MenuItemDTOResponse toggleAvailability(Long restaurantId, Long id, User user);
}
